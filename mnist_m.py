...
class MNIST_M(data.Dataset):
    ...
    def __init__(self, root, split='train', transform=None, target_transform=None):
        ...
        split_list = {"train":"train_mnist_m" , "test":"test_mnist_m"}
        ...
        self.filename = f"{split_list[self.split]}.mat" # Split should be one of "train", "test" , "extra_svhn" , "extra_emnist"
